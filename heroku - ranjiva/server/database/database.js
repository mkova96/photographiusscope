      ...
      throw err
        ...
        (err) => {
            if (err) {
                ...
                var insert = 'INSERT INTO user (id,email, password,firstName,lastName, money,profileLink) VALUES (?,?,?,?,?,?,?)'
                db.run(insert, [1,"admin@mail.hr", "admin","Admin","Admin",0,null]);
                db.run(insert, [2,"sawyer@mail.hr", "123","Thomas","Sawyer",10000,"http://localhost:8080/secure/thomas-sawyer.html"]);               
                db.run(insert, [3,"napadac@mail.hr", "qwerty","Napadac","Napadac",10000,
                ...
                db.run(insert, [4,"zrtva@mail.hr", "password","Zrtva","Zrtva",10000,null]);                              
            }
        });
